...
- Generated: 2026-05-11T10:46:59.111171+00:00
- Runs: 6
...
- Result count: 5
- Results:
  - Palace of the Governors (history) match=primary score=81.0
    summary: Museum or interpretive site with clear historical context.
    breakdown: point_proximity=15.1, radius_fit=10.0, significance=21.3, quality=9.0, mode_affinity=6.0, institutional_identity=3.6
  - Santa Fe Plaza (civic) match=secondary score=73.3
    summary: Civic space that helps explain the structure of public life.
    breakdown: point_proximity=16.9, radius_fit=11.3, significance=21.9, quality=9.0, mode_affinity=7.2, penalties=-1.5
  - New Mexico History Museum (history) match=primary score=71.8
    summary: Museum or interpretive site with clear historical context.
    breakdown: point_proximity=14.0, radius_fit=9.3, significance=20.4, quality=8.5, mode_affinity=6.0, institutional_identity=3.6
...
- Results:
  ...
  - Palace of the Governors (history) match=primary score=78.6
    summary: Museum or interpretive site with clear historical context.
    breakdown: route_proximity=11.0, detour_fit=8.7, budget_fit=3.0, significance=21.3, quality=9.0, mode_affinity=6.0
